...
class AnimeCrawler {
  ...
  AnimeCrawler() : _dbRef = FirebaseDatabase.instance.ref().child(AppConstants.animeVideosNode);
  ...
  Future<List<VideoModel>> _simulateCrawling() async {
    ...
    return [
      VideoModel(
        id: 'anime_${DateTime.now().millisecondsSinceEpoch}_1',
        title: '新爬取的動漫影片 1',
        description: '這是一個新爬取的動漫影片',
        thumbnailUrl: 'https://via.placeholder.com/300x200/4ECDC4/FFFFFF?text=新動漫影片1',
      ...
      VideoModel(
        id: 'anime_${DateTime.now().millisecondsSinceEpoch}_2',
        title: '新爬取的動漫影片 2',
        description: '這是另一個新爬取的動漫影片',
        thumbnailUrl: 'https://via.placeholder.com/300x200/FF6B9D/FFFFFF?text=新動漫影片2',
